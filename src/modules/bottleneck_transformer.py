...
from src.utils.torch_utils import to_2tuple, make_divisible, trunc_normal_
from src.utils.trace_utils import _assert
...
class BottleneckAttnGenerator(GeneratorAbstract):
    """ Bottleneck Transformer block generator.

        BottleneckAttn args consists,
        repeat(=n), [dim_out, feature_size, stride, num_heads] 
    """
    ...
    def out_channel(self) -> int:
        ...
        return self._get_divisible_channel(self.args[0] * self.width_multiply) # self.args = []
